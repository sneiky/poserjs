...
INSERT INTO formulas VALUES ("0","работа силы упругости","| A | =\\frac{ | k | }{ | 2 | }( | x_1^2 | - | x_2^2 | )","1");
...
INSERT INTO formulas VALUES ("0","модуль напряженности электростатического поля, заряженного поля","| E | = | k | \\frac{ | \\vert q_ш \\vert | }{ | &epsilon; | ( | R | + | r | )^2 }","4");
